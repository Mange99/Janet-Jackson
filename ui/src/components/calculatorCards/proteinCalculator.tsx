...
function proteinCalculate(
  ...
  return gender
    ? Math.round(weight * 0.8 * 1 * (activity * 0.8) * type)
    : Math.round(weight * 0.8 * 0.82 * (activity * 0.8) * type);
}
      ...
      <Card style={{ width: "25rem" }}>
        <Card.Body>
          ...
          <Form>
            <Form.Group>
              <Form.Check
                ...
                id={`inline-radio-5`}
                onChange={() => (
                  setProteinIntake(true), setType(typeOfGoal.maintenacne)
                )}
              />
              <Form.Check
                inline
                ...
                id={`inline-radio-6`}
                onChange={() => (
                  setProteinIntake(true), setType(typeOfGoal.muscleGain)
                )}
              />
              <Form.Check
                inline
                ...
                id={`inline-radio-7`}
                onChange={() => (
                  setProteinIntake(true), setType(typeOfGoal.fatLoss)
                )}
              />
            </Form.Group>
          </Form>
          ...
          <Button
            mt={3}
            onClick={() =>
              setProtein(proteinCalculate(gender, activity, typeOfGoals))
            }
          >
            Calculate
          </Button>
